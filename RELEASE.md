# Safe HTML Reader v1.0.0

First stable release of Safe HTML Reader for EdgeEver Plugin API v1.

## Highlights

- Adds the **Open Safe HTML Reading View** command and a focused reading panel.
...
The release tag must be `1.0.0` or `v1.0.0`. The release manifest must exactly match the `manifest.json` on the repository default branch.
